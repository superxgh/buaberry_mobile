...
class ThemeConfig {
  ...
  static ThemeData get lightTheme => createTheme(
        ...
        background: ColorConstants.foodPrimaryLightColor,

        cardBackground: ColorConstants.secondaryAppColor,
        primaryText: Colors.black,
        secondaryText: Colors.white,
        accentColor: ColorConstants.foodPrimaryLightColor,
  ...
  static ThemeData get darkTheme => createTheme(
        ...
        background: ColorConstants.foodPrimaryColor,
        cardBackground: ColorConstants.secondaryDarkAppColor,
        primaryText: Colors.white,
        secondaryText: Colors.black,
        accentColor: ColorConstants.foodPrimaryColor,
